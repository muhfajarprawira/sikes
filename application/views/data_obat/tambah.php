...
<div class="container-fluid">
	<!-- Page Heading -->
	<div class="clearfix">
		<h5 class="h3 mb-4 text-gray-800 float-left">Tambah Data Obat</h5>
	...
	<div class="card">
		...
		<div class="card-body">
			<form action="<?= base_url('data_obat/tambah_data_action'); ?>" method="post">
				...
				<div class="form-group">
					...
					<input type="text" name="dosis_aturan_obat" class="form-control">
				</div>
